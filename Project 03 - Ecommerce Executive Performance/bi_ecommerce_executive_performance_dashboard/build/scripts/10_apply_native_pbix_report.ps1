...
if (!(Test-Path -LiteralPath $ModelPbix)) {
  Write-Validation @{
    ...
    reason = "No Project 03 - Ecommerce Executive Performance output/dashboard_model.pbix exists. The script will not create or rename a fake PBIX; provide a valid model PBIX or complete the assisted Power BI Desktop save step first."
  } 2
}
