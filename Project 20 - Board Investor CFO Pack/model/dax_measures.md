...
Portfolio Signature SVG = VAR SVG =
    "<svg xmlns=""http://www.w3.org/2000/svg"" viewBox=""0 0 64 64"" role=""img"" aria-label=""AT modern FP&amp;A monogram""> <defs> <linearGradient id=""bg"" x1=""7"" y1=""58"" x2=""57"" y2=""6"" gradientUnits=""userSpaceOnUse""> <stop stop-color=""%230a1323""/> <stop offset=""0.58"" stop-color=""%23101b2d""/> <stop offset=""1"" stop-color=""%2314303a""/> </linearGradient> <linearGradient id=""accent"" x1=""12"" y1=""51"" x2=""52"" y2=""44"" gradientUnits=""userSpaceOnUse""> <stop stop-color=""%238ab8ff""/> <stop offset=""1"" stop-color=""%238de1d6""/> </linearGradient> </defs> <rect width=""64"" height=""64"" rx=""14"" fill=""url(%23bg)""/> <text x=""8.5"" y=""43"" fill=""%23f8fbff"" font-family=""Arial, Helvetica, sans-serif"" font-size=""31"" font-weight=""900"">AT</text> <rect x=""6"" y=""13"" width=""56"" height=""10"" rx=""1.5"" fill=""%23101b2d""/> <path d=""M12 50C22 46.5 35 48 52 42.5"" fill=""none"" stroke=""url(%23accent)"" stroke-width=""2.8"" stroke-linecap=""round"" opacity=""0.88""/> <circle cx=""52"" cy=""42.5"" r=""2.85"" fill=""%23e9bf72""/> </svg>"
RETURN "data:image/svg+xml;utf8," & SVG
```
...
VAR SVG =
    ...
    "<rect x='16' y='13' width='220' height='4.5' rx='2.25' fill='%234F87F5' opacity='0.9'/>" &
    "<rect x='16' y='32' width='13' height='13' rx='3' fill='%234F87F5' opacity='0.95'/>" &
    "<circle cx='22.5' cy='38.5' r='2.2' fill='%23FFFFFF' opacity='0.85'/>" &
    "<text x='36' y='43' font-family='Segoe UI' font-size='15' font-weight='750' fill='%23211A32'>Revenue</text>" &
    "<text x='16' y='91' font-family='Segoe UI' font-size='30' font-weight='750' fill='%234F87F5'>" & ValueText & "</text>" &
...
VAR SVG =
    "<svg xmlns='http://www.w3.org/2000/svg' width='252' height='158' viewBox='0 0 252 158'>" &
    "<rect x='1' y='1' width='250' height='156' rx='15' fill='%23F4EFFA' stroke='%237142A4' stroke-width='2.5'/>" &
    "<rect x='16' y='13' width='220' height='4.5' rx='2.25' fill='%230F9F95' opacity='0.9'/>" &
    "<rect x='16' y='32' width='13' height='13' rx='3' fill='%230F9F95' opacity='0.95'/>" &
    "<circle cx='22.5' cy='38.5' r='2.2' fill='%23FFFFFF' opacity='0.85'/>" &
    "<text x='36' y='43' font-family='Segoe UI' font-size='15' font-weight='750' fill='%23211A32'>Margin</text>" &
    "<text x='16' y='91' font-family='Segoe UI' font-size='30' font-weight='750' fill='%230F9F95'>" & ValueText & "</text>" &
    "<rect x='130' y='34' width='104' height='54' rx='8' fill='%23FFFFFF' opacity='0.46'/>" &
    "<rect x='136' y='59' width='92' height='12' rx='6' fill='" & BandColor & "'/>" &
    "<rect x='141' y='52' width='12' height='26' rx='2' fill='%23D9D1EB' opacity='0.34'/>" &
    "<rect x='160' y='48' width='12' height='30' rx='2' fill='%23D9D1EB' opacity='0.28'/>" &
...
VAR SVG =
    "<svg xmlns='http://www.w3.org/2000/svg' width='252' height='158' viewBox='0 0 252 158'>" &
    "<rect x='1' y='1' width='250' height='156' rx='15' fill='%23F4EFFA' stroke='%237142A4' stroke-width='2.5'/>" &
    "<rect x='16' y='13' width='220' height='4.5' rx='2.25' fill='%231F8E45' opacity='0.9'/>" &
    "<rect x='16' y='32' width='13' height='13' rx='3' fill='%231F8E45' opacity='0.95'/>" &
    "<circle cx='22.5' cy='38.5' r='2.2' fill='%23FFFFFF' opacity='0.85'/>" &
    "<text x='36' y='43' font-family='Segoe UI' font-size='15' font-weight='750' fill='%23211A32'>EBITDA</text>" &
    "<text x='16' y='91' font-family='Segoe UI' font-size='30' font-weight='750' fill='%231F8E45'>" & ValueText & "</text>" &
    "<rect x='130' y='34' width='104' height='54' rx='8' fill='%23FFFFFF' opacity='0.46'/>" &
    "<rect x='136' y='59' width='92' height='12' rx='6' fill='" & BandColor & "'/>" &
    "<rect x='141' y='52' width='12' height='26' rx='2' fill='%23D9D1EB' opacity='0.34'/>" &
    "<rect x='160' y='48' width='12' height='30' rx='2' fill='%23D9D1EB' opacity='0.28'/>" &
...
VAR SVG =
    "<svg xmlns='http://www.w3.org/2000/svg' width='252' height='158' viewBox='0 0 252 158'>" &
    "<rect x='1' y='1' width='250' height='156' rx='15' fill='%23F4EFFA' stroke='%237142A4' stroke-width='2.5'/>" &
    "<rect x='16' y='13' width='220' height='4.5' rx='2.25' fill='%23BE7C10' opacity='0.9'/>" &
    "<rect x='16' y='32' width='13' height='13' rx='3' fill='%23BE7C10' opacity='0.95'/>" &
    "<circle cx='22.5' cy='38.5' r='2.2' fill='%23FFFFFF' opacity='0.85'/>" &
    "<text x='36' y='43' font-family='Segoe UI' font-size='15' font-weight='750' fill='%23211A32'>Cash</text>" &
    "<text x='16' y='91' font-family='Segoe UI' font-size='30' font-weight='750' fill='%23BE7C10'>" & ValueText & "</text>" &
    "<rect x='130' y='34' width='104' height='54' rx='8' fill='%23FFFFFF' opacity='0.46'/>" &
    "<rect x='136' y='59' width='92' height='12' rx='6' fill='" & BandColor & "'/>" &
    "<rect x='141' y='52' width='12' height='26' rx='2' fill='%23D9D1EB' opacity='0.34'/>" &
    "<rect x='160' y='48' width='12' height='30' rx='2' fill='%23D9D1EB' opacity='0.28'/>" &
...
VAR SVG =
    ...
    "<rect x='16' y='32' width='13' height='13' rx='3' fill='%234F87F5' opacity='0.95'/>" &
    "<circle cx='22.5' cy='38.5' r='2.2' fill='%23FFFFFF' opacity='0.85'/>" &
    "<text x='36' y='43' font-family='Segoe UI' font-size='15' font-weight='750' fill='%23211A32'>Runway</text>" &
    "<text x='16' y='91' font-family='Segoe UI' font-size='30' font-weight='750' fill='%234F87F5'>" & ValueText & "</text>" &
    "<rect x='130' y='34' width='104' height='54' rx='8' fill='%23FFFFFF' opacity='0.46'/>" &
    "<rect x='136' y='59' width='92' height='12' rx='6' fill='" & BandColor & "'/>" &
    "<rect x='141' y='52' width='12' height='26' rx='2' fill='%23D9D1EB' opacity='0.34'/>" &
...
VAR SVG =
    ...
    "<rect x='16' y='32' width='13' height='13' rx='3' fill='%230F9F95' opacity='0.95'/>" &
    "<circle cx='22.5' cy='38.5' r='2.2' fill='%23FFFFFF' opacity='0.85'/>" &
    "<text x='36' y='43' font-family='Segoe UI' font-size='15' font-weight='750' fill='%23211A32'>FCF</text>" &
    "<text x='16' y='91' font-family='Segoe UI' font-size='30' font-weight='750' fill='%230F9F95'>" & ValueText & "</text>" &
    "<rect x='130' y='34' width='104' height='54' rx='8' fill='%23FFFFFF' opacity='0.46'/>" &
    "<rect x='136' y='59' width='92' height='12' rx='6' fill='" & BandColor & "'/>" &
    "<rect x='141' y='52' width='12' height='26' rx='2' fill='%23D9D1EB' opacity='0.34'/>" &
...
VAR SVG =
    "<svg xmlns='http://www.w3.org/2000/svg' width='252' height='158' viewBox='0 0 252 158'>" &
    "<rect x='1' y='1' width='250' height='156' rx='15' fill='%23F4EFFA' stroke='%237142A4' stroke-width='2.5'/>" &
    "<rect x='16' y='13' width='220' height='4.5' rx='2.25' fill='%23B73535' opacity='0.9'/>" &
    "<rect x='16' y='32' width='13' height='13' rx='3' fill='%23B73535' opacity='0.95'/>" &
    "<circle cx='22.5' cy='38.5' r='2.2' fill='%23FFFFFF' opacity='0.85'/>" &
    "<text x='36' y='43' font-family='Segoe UI' font-size='15' font-weight='750' fill='%23211A32'>Burn</text>" &
    "<text x='16' y='91' font-family='Segoe UI' font-size='30' font-weight='750' fill='%23B73535'>" & ValueText & "</text>" &
    "<rect x='130' y='34' width='104' height='54' rx='8' fill='%23FFFFFF' opacity='0.46'/>" &
    "<rect x='136' y='59' width='92' height='12' rx='6' fill='" & BandColor & "'/>" &
    "<rect x='141' y='52' width='12' height='26' rx='2' fill='%23D9D1EB' opacity='0.34'/>" &
    "<rect x='160' y='48' width='12' height='30' rx='2' fill='%23D9D1EB' opacity='0.28'/>" &
...
VAR SVG =
    ...
    "<rect x='16' y='32' width='13' height='13' rx='3' fill='%231F8E45' opacity='0.95'/>" &
    "<circle cx='22.5' cy='38.5' r='2.2' fill='%23FFFFFF' opacity='0.85'/>" &
    "<text x='36' y='43' font-family='Segoe UI' font-size='15' font-weight='750' fill='%23211A32'>Funding</text>" &
    "<text x='16' y='91' font-family='Segoe UI' font-size='30' font-weight='750' fill='%231F8E45'>" & ValueText & "</text>" &
    "<rect x='130' y='34' width='104' height='54' rx='8' fill='%23FFFFFF' opacity='0.46'/>" &
    "<rect x='136' y='59' width='92' height='12' rx='6' fill='" & BandColor & "'/>" &
    "<rect x='141' y='52' width='12' height='26' rx='2' fill='%23D9D1EB' opacity='0.34'/>" &
...
VAR SVG =
    ...
    "<rect x='16' y='32' width='13' height='13' rx='3' fill='%234F87F5' opacity='0.95'/>" &
    "<circle cx='22.5' cy='38.5' r='2.2' fill='%23FFFFFF' opacity='0.85'/>" &
    "<text x='36' y='43' font-family='Segoe UI' font-size='15' font-weight='750' fill='%23211A32'>EV</text>" &
    "<text x='16' y='91' font-family='Segoe UI' font-size='30' font-weight='750' fill='%234F87F5'>" & ValueText & "</text>" &
    "<rect x='130' y='34' width='104' height='54' rx='8' fill='%23FFFFFF' opacity='0.46'/>" &
    "<rect x='136' y='59' width='92' height='12' rx='6' fill='" & BandColor & "'/>" &
    "<rect x='141' y='52' width='12' height='26' rx='2' fill='%23D9D1EB' opacity='0.34'/>" &
...
VAR SVG =
    ...
    "<rect x='16' y='32' width='13' height='13' rx='3' fill='%231F8E45' opacity='0.95'/>" &
    "<circle cx='22.5' cy='38.5' r='2.2' fill='%23FFFFFF' opacity='0.85'/>" &
    "<text x='36' y='43' font-family='Segoe UI' font-size='15' font-weight='750' fill='%23211A32'>Equity</text>" &
    "<text x='16' y='91' font-family='Segoe UI' font-size='30' font-weight='750' fill='%231F8E45'>" & ValueText & "</text>" &
    "<rect x='130' y='34' width='104' height='54' rx='8' fill='%23FFFFFF' opacity='0.46'/>" &
    "<rect x='136' y='59' width='92' height='12' rx='6' fill='" & BandColor & "'/>" &
    "<rect x='141' y='52' width='12' height='26' rx='2' fill='%23D9D1EB' opacity='0.34'/>" &
...
VAR SVG =
    ...
    "<rect x='16' y='32' width='13' height='13' rx='3' fill='%23BE7C10' opacity='0.95'/>" &
    "<circle cx='22.5' cy='38.5' r='2.2' fill='%23FFFFFF' opacity='0.85'/>" &
    "<text x='36' y='43' font-family='Segoe UI' font-size='15' font-weight='750' fill='%23211A32'>Leverage</text>" &
    "<text x='16' y='91' font-family='Segoe UI' font-size='30' font-weight='750' fill='%23BE7C10'>" & ValueText & "</text>" &
    "<rect x='130' y='34' width='104' height='54' rx='8' fill='%23FFFFFF' opacity='0.46'/>" &
    "<rect x='136' y='59' width='92' height='12' rx='6' fill='" & BandColor & "'/>" &
    "<rect x='141' y='52' width='12' height='26' rx='2' fill='%23D9D1EB' opacity='0.34'/>" &
...
VAR SVG =
    ...
    "<rect x='16' y='32' width='13' height='13' rx='3' fill='%230F9F95' opacity='0.95'/>" &
    "<circle cx='22.5' cy='38.5' r='2.2' fill='%23FFFFFF' opacity='0.85'/>" &
    "<text x='36' y='43' font-family='Segoe UI' font-size='15' font-weight='750' fill='%23211A32'>Headroom</text>" &
    "<text x='16' y='91' font-family='Segoe UI' font-size='30' font-weight='750' fill='%230F9F95'>" & ValueText & "</text>" &
    "<rect x='130' y='34' width='104' height='54' rx='8' fill='%23FFFFFF' opacity='0.46'/>" &
    "<rect x='136' y='59' width='92' height='12' rx='6' fill='" & BandColor & "'/>" &
    "<rect x='141' y='52' width='12' height='26' rx='2' fill='%23D9D1EB' opacity='0.34'/>" &
...
VAR SVG =
    ...
    "<rect x='16' y='32' width='13' height='13' rx='3' fill='%23B73535' opacity='0.95'/>" &
    "<circle cx='22.5' cy='38.5' r='2.2' fill='%23FFFFFF' opacity='0.85'/>" &
    "<text x='36' y='43' font-family='Segoe UI' font-size='15' font-weight='750' fill='%23211A32'>Risk</text>" &
    "<text x='16' y='91' font-family='Segoe UI' font-size='30' font-weight='750' fill='%23B73535'>" & ValueText & "</text>" &
    "<rect x='130' y='34' width='104' height='54' rx='8' fill='%23FFFFFF' opacity='0.46'/>" &
    "<rect x='136' y='59' width='92' height='12' rx='6' fill='" & BandColor & "'/>" &
    "<rect x='141' y='52' width='12' height='26' rx='2' fill='%23D9D1EB' opacity='0.34'/>" &
