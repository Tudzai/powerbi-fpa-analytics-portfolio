...
def main() -> None:
    layout = build_layout()
    output = BUILD_DIR / "native_report_layout_v06.json"
    ...
    summary = {
        ...
        "visual_strategy": "native Power BI visual containers only except page title textboxes",
    }
    write_json(BUILD_DIR / "native_report_layout_v06_summary.json", summary)
